    ...
    <div>
      ...
      <div className="p-4 sm:p-6 lg:p-8 max-w-2xl space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Link href="/admin/price-scanner" className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-5 hover:bg-gray-50 hover:border-gray-300 transition-colors group">
            <span className="text-2xl">📂</span>
            <div>
              <p className="text-sm font-semibold text-gray-900">Price Scanner</p>
              <p className="text-xs text-gray-500 mt-0.5">Bulk scan Drive folder for new price lists</p>
            </div>
            <span className="ml-auto text-gray-300 group-hover:translate-x-0.5 transition-transform">→</span>
          </Link>
          <Link href="/admin/brand-preferences" className="flex items-center gap-4 bg-white border border-gray-200 rounded-xl p-5 hover:bg-gray-50 hover:border-gray-300 transition-colors group">
            <span className="text-2xl">⭐</span>
            <div>
              <p className="text-sm font-semibold text-gray-900">Brand Preferences</p>
              <p className="text-xs text-gray-500 mt-0.5">Smart Order brand boost rules (eraser→Faber Castell etc.)</p>
            </div>
            <span className="ml-auto text-gray-300 group-hover:translate-x-0.5 transition-transform">→</span>
          </Link>
